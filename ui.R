...
sidebar <- dashboardSidebar(
    sidebarMenu(
        ...
        menuItem(
            ...
            menuSubItem("Estimating one proportion", tabName = "1prop_est"),
            menuSubItem("Hypothesis tests for a population proportion", tabName = "1prop_hypo"),
            menuSubItem("Estimating difference between two proportions", tabName = "2props_est"),
            menuSubItem("Hypothesis tests for two proportions", tabName = "2props_hypo"),
            menuSubItem("Hypothesis tests for two proportions (small proportion)", tabName = "2props_hypo_small")
            ),
        menuItem(
            "Continuous outcome", 
            icon = icon("chart-line"), startExpanded = FALSE,
            menuSubItem("Estimating one mean", tabName = "1mean_est"),
            menuSubItem("Hypothesis tests for a population mean", tabName = "1mean_hypo"),
            menuSubItem("Estimating difference between two means", tabName = "2means_est"),
            menuSubItem("Hypothesis tests for two means", tabName = "2means_hypo")
            ),
        menuItem(
            "Cohort studies",
            icon = icon("university"), startExpanded = FALSE,
            menuSubItem("Estimating RR", tabName = "cohort_est"),
            menuSubItem("Hypothesis tests for RR", tabName = "cohort_hypo")
        ),
        menuItem(
            "Case-control studies",
            icon = icon("microscope"), startExpanded = FALSE,
            menuSubItem("Estimating OR", tabName = "case_est"),
            menuSubItem("Hypothesis tests for OR", tabName = "case_hypo")
        ),
        # menuItem(
        ...
        menuItem(
            ...
            menuSubItem("Estimating sensitivity", tabName = "sens"),
            menuSubItem("Estimating specificity", tabName = "spec"),
            menuSubItem("Estimating AUC", tabName = "AUC")
        ),
        menuItem(
                ...
                tabPanel(
                    ...
                    fluidRow(
                        box(title = "Sample size", width = 6,
                            ...
                            box(
                                p(HTML("<center><b>Sample size</b></center>")),
                        ...
                        box(title = "Formula", width = 6,
                            conditionalPanel(
                                ...
                                withMathJax(),
                                p("Formula 1: $$n=\\frac{Z_{1-\\frac{\\alpha}{2}}^2P(1-P)}{d^2}$$")
                            ),
                            conditionalPanel(
                                condition = "input.precision_type_1prop_est == 2",
                                withMathJax(),
                                p("Formula 2: $$n=\\frac{Z_{1-\\frac{\\alpha}{2}}^2(1-P)}{\\varepsilon^2P}$$")
                            )
                        )
                    )
                ),
                        ...
                        tabBox(
                            ...
                            tabPanel(
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        p(HTML("<center><b>Power</b></center>")),
                    ...
                    fluidRow(
                        ...
                        box(title = "Formula", width = 6,
                            conditionalPanel(
                                ...
                                withMathJax(),
                                p("Formula 1: $$n=\\frac{Z_{1-\\frac{\\alpha}{2}}^2\\sigma^2}{d^2}$$")
                            ),
                            conditionalPanel(
                                condition = "input.precision_type_1mean_est == 2",
                                withMathJax(),
                                p("Formula 2: $$n=\\frac{Z_{1-\\frac{\\alpha}{2}}^2\\sigma^2}{\\varepsilon^2\\mu^2}$$")
                            )
                        )
                    )
                )
                ...
                tabPanel(
                    ...
                    fluidRow(
                        ...
                        box(title = "Formula", width = 6,
                            ...
                            p(HTML("&sigma;: được tính bằng Formula")),
